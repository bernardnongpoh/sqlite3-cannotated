...
case OP_Remainder: {           /* same as TK_REM, in1, in2, out3 */
  ...
  if( (type1 & type2 & MEM_Int)!=0 ){
    ...
    iB = pIn2->u.i;
    switch( pOp->opcode ){
      case OP_Add:       if( sqlite3AddInt64(&iB,iA) ) { goto fp_math;  
}break;
      case OP_Subtract:  if( sqlite3SubInt64(&iB,iA) ) { goto fp_math;  
}break;
      case OP_Multiply:  if( sqlite3MulInt64(&iB,iA) ) { goto fp_math;  
}break;
      case OP_Divide: {
